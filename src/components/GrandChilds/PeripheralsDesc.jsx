...
export default class ProductDesc extends react.Component{
    ...
    getProducts = () =>{
        ...
        axios.get(urlBase+"peripherals/description/"+word).then(response=>{
            ...
            swal.fire({
                title: "Consultado!",
                text: `Se ha realizado la busqueda de los productos que coinciden con la palabra ${word} en su descripción`,
                icon: "info"
            })
        }).catch(error=>{
        ...
        return(
            <div className="container-content">
                <div className="content">
                    <h1 className="title fs-1"> Productos por descripción. </h1>
