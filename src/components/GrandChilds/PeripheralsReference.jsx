...
export default class ProductReference extends react.Component{
    constructor(props){
        super(props)
        this.state={
            items: [],
    ...
    getProducts = () =>{
        ...
        axios.get(urlBase+"peripherals/name/"+reference).then(response=>{
            ...
            swal.fire({
                title: "Consultado!",
                text: `Se ha realizado la busqueda de los productos con nombre: ${reference}`,
                icon: "info"
            })
        }).catch(error=>{
        ...
        return(
            <div className="container-content">
                <div className="content">
                    <h1 className="title fs-1"> Productos por referencia. </h1>
