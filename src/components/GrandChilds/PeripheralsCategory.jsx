...
export default class ProductDesc extends react.Component{
    ...
    getProducts = () =>{
        ...
        axios.get(urlBase+"peripherals/category/"+category).then(response=>{
        ...
        swal.fire({
            title: "Consultado!",
            text: `Se ha realizado la busqueda de los productos con la cateogria de ${category}`,
            icon: "info"
        })
        ...
        return(
            <div className="container-content">
                <div className="content">
                    <h1 className="title fs-1"> Productos por categoria. </h1>
